...
function GameOver(props) {
  return (
    <div className="gameOver">
      ...
      <br />
      My Score: {props.personalStats.correctClicks} My Mistakes:{" "}
      {props.personalStats.incorrectClicks}
      <br />
...
function ReadyView(props) {
  return (
    <div className="readyView">
      ...
      <br />
      <a href="mailto:sterlinghirsh@gmail.com">sterlinghirsh@gmail.com</a>
    </div>
  );
}
